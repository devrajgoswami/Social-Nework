...
<!--                <a href="./home.do">Home</a>-->
        ...
        <div id="container">
            ...
            <%
                ArrayList<ActivityVO> activities = DAOService.getUserDAO().getActivities((Integer)session.getAttribute("userNO"));
                for(ActivityVO activity:activities ){
            %>
            <div id="activity">
                <p id="activityTitle">
                    <span id="by"><%=DAOService.getUserDAO().getFullName(activity.getActivityBy())+" : "%></span>
                    <span id="at"><%=activity.getTime()%></span>
                </p>
                <p id="message"><%=activity.getMessage()%></p>      
            </div>
            <%  } %>
            </div>
            <div id="right">
